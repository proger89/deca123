    ...
    "processes": {
        "RuntimeController": {
            ...
            "devices": [
                ...
                "RangeFinder:rangefinder_left",
                "RangeFinder:rangefinder_right",
                "RangeFinder:rangefinder_front",
                "RangeFinder:rangefinder_rear",
                "DistanceSensor:photoeye_entry",
                "PositionSensor:belt_encoder",
                "PositionSensor:dimension_gate_position",
                "PositionSensor:shape_gate_position",
